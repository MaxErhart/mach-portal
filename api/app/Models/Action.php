...
class Action extends Model
{
    ...
    protected $casts = [
        ...
        'created_at'=>\App\Casts\TimeCast::class,
        'updated_at'=>\App\Casts\TimestampCast::class,
    ];

    protected function serializeCreatedAt(DateTimeInterface $date)
    {
