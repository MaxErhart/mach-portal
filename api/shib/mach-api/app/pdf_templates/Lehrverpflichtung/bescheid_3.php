...
function create($submissions_group,$file,$prof,$inst,$semester,$ml_1=null,$ml_2=null) {
  // dd([$ml_1,$ml_2]);
  ...
  if($submissions_group[0]->_data[1083]==1) {
    $ticked_box_prof = [true,false,false];
  } else if($submissions_group[0]->_data[1083]==2) {
    $ticked_box_prof = [false,true,false];

  } else if($submissions_group[0]->_data[1083]==3) {
    $ticked_box_prof = [false,false,true];
  }

  $ticked_box_mitarb = [false,false,false];
  if($submissions_group[0]->_data[1085]==0) {
    $ticked_box_mitarb = [true,false,false];
  } else if($submissions_group[0]->_data[1085]==1) {
    $ticked_box_mitarb = [false,true,false];

  } else if($submissions_group[0]->_data[1085]==2) {
