<?php
namespace PdfTemplates\NichtBestandenNichtTeilgenommen;
...
Sie haben diese Prüfung nicht bestanden, da Sie nicht an der Prüfung teilgenommen haben.

Bitte beachten Sie, dass Sie laut Zugangssatzung maximal zweimal an der Aufnahmeprüfung teilnehmen dürfen. 
...
KIT-Fakultät für Maschinenbau*"
    ...
    if (preg_match('/^[\/\w\-. ]+$/', $name)) {
        $filename = "nicht_teilgenommen_{$bewerbungs_nummer}_{$name}_{$today}_{$uniqid}.pdf";
    } else {
        $filename = "nicht_teilgenommen_{$bewerbungs_nummer}_{$today}_{$uniqid}.pdf";
    } 
