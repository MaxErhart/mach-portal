...
Bitte beachten Sie, dass Sie laut Zugangssatzung nur maximal zweimal an der Aufnahmeprüfung teilnehmen dürfen. 
...
KIT-Fakultät für Maschinenbau*"
    ...
    if (preg_match('/^[\/\w\-. ]+$/', $name)) {
        $filename = "nicht_bestanden_{$bewerbungs_nummer}_{$name}_{$today}_{$uniqid}.pdf";
    } else {
        $filename = "nicht_bestanden_{$bewerbungs_nummer}_{$today}_{$uniqid}.pdf";
    } 
