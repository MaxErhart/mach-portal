  ...
  <div class="registration">
    ...
    <div class="reg-body">
      <form @submit.prevent="submit()" class="form" ref="form">
        <h2 class="form-title">Registration for the entrance examination of summer term 2022</h2>


        <div class="section-group">
          <span>Personal information</span>
          <section>
            <SelectElement name="sex" :data="sex" ref="sex"/>
          </section>

          <section>
            <InputElement name="firstname" :data="fnameinput"  ref="fnameinput"/>
          </section>

          <section>
            <InputElement name="lastname" :data="lnameinput"  ref="lnameinput"/>
          </section>

          <section>
            <InputElement name="email" :data="emailinput"  ref="emailinput"/>
          </section>

          <section>
            <InputElement name="date_of_birth" :data="birthinput"  ref="birthinput"/>
          </section>
        </div>
        ...
        <div class="section-group">
          <span>Address</span>
          <section>
            <InputElement name="street" :data="street"  ref="street"/>
          </section>

          <!-- <section>
            <InputElement name="street_number" :data="streetNo"  ref="streetNo"/>
          </section> -->

          <section>
            <InputElement name="zipcode" :data="zipcode"  ref="zipcode"/>
          </section>

          <section>
            <InputElement name="city" :data="city"  ref="city"/>
          </section>        

          <section>
            <SelectElement name="country" :data="country" :typeToSearch="true"  ref="country"/>
          </section>          
        </div>
        ...
        <div class="section-group">
          ...
          <section>
            <InputElement name="application_number" :data="application_number" :customValid="customValidApplication"  ref="application_number"/>
          </section>

          <section>
            <InputElement name="applicant_number" :data="applicant_number" :customValid="customValidApplicant" ref="applicant_number"/>
          </section>

          <section>
            <SelectElement name="degree" :data="degree"  ref="degree"/>
          </section>          
        </div>

        <section>
          <Checkbox name="consentExam" :data="consentExam" ref="consentExam"/>
        </section>

        <section>
          <Checkbox name="consentDataStorage" :data="consentDataStorage" ref="consentDataStorage"/>
        </section>        

        <section>
          <Checkbox name="consentPrevExam" :data="consentPrevExam" ref="consentPrevExam"/>
        </section>

        <section>
          <Button :loading="submitLoading" :disabled="submitDisabled" text="Submit" ref="button"/>
        </section>                                    
      </form>
    </div>
